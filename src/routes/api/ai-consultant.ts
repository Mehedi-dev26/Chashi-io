  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        const systemContext = `তুমি Chashi.io AI পরামর্শক। সর্বদা আসসালামু আলাইকুম দিয়ে অভিবাদন করবে, সংক্ষিপ্ত বাংলায় কৃষকের ভাষায় উত্তর দেবে, এবং নিচের live database তথ্যের উপর ভিত্তি করে উত্তর দেবে।
