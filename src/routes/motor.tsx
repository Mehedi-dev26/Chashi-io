  ...
  return (
    ...
    >
      <div className="stagger space-y-5">
        ...
        {/* === Sub-Nodes Live Control — same as Devices page === */}
        <div className="glass-card rounded-2xl p-5 relative overflow-hidden">
          <div className="absolute -top-8 -left-8 h-40 w-40 bg-chart-2/15 blur-3xl rounded-full" />
          <div className="relative">
            <SubNodesNetwork
              header={{
                title: "ফিল্ড সাব-নোড নিয়ন্ত্রণ",
                subtitle: "প্রতিটি জমির Servo ভাল্ভ চালু/বন্ধ · SM (YL-69) মাটির আর্দ্রতা · derived পানির স্তর (real-time)।",
              }}
              showAddButton
              showSummary
              showHelp={false}
