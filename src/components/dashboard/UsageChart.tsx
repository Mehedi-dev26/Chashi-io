...
// Stable mock data (no Math.random — prevents SSR hydration mismatch)
          ...
          <AreaChart data={data} margin={{ top: 5, right: 0, left: -20, bottom: 0 }}>
            <defs>
              <linearGradient id="g1" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="oklch(0.62 0.16 150)" stopOpacity={0.5} />
            ...
            />
            <Area type="monotone" dataKey="water" stroke="oklch(0.62 0.16 150)" strokeWidth={2} fill="url(#g1)" />
